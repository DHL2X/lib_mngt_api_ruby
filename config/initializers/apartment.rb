...
require 'apartment/custom_elevator'
...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{Server}
  ...
  # end
  #
  config.tenant_names = -> { Server.pluck :domain }
...
Rails.application.config.middleware.use Apartment::CustomElevator
