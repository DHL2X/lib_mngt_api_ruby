...
ActiveRecord::Schema[7.0].define(version: 2023_11_01_093507) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "server_id"
    t.index ["server_id"], name: "index_books_on_server_id"
  ...
  add_foreign_key "books", "servers"
  add_foreign_key "leases", "books"
